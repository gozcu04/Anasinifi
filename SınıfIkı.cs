...
{
    public partial class SınıfIkı : Form
    {
        public SınıfIkı()
        {
            InitializeComponent();
        ...
        void listele()
        {
            //Sınıf2 Verilerini Datagride çekme
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into SınıfIkı (AD,SOYAD,YAS,CINSIYET) values (@o1,@o2,@o3,@o4)", baglanti);
        ...
        {
            baglanti.Open();
            SqlCommand komutsil = new SqlCommand("Delete From SınıfIkı where ID=@o1", baglanti);
        ...
        {
            baglanti.Open();
            SqlCommand komutguncelle = new SqlCommand("Update SınıfIkı set AD=@o1,SOYAD=@o2,YAS=@o3,CINSIYET=@o4 where ID=@o5", baglanti);
